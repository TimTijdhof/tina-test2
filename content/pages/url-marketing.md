...
hero:
  ...
  content: '<div class="usp-list"><ul><li>Slimme pop-up van elk gesprek</li><li>Direct
    de klantgegevens in beeld</li><li>Werk efficiënter</li></ul></div>De URL Executer is een generieke CRM koppeling. Specifiek gericht op excellente communicatie met jouw klanten. Email, chat, Whatsapp en natuurlijk hoort daar ook telefonie bij! En daar komt Callvoip om de hoek kijken: koppel jouw URL Executer nu aan onze telefonie en profiteer van het gemak en de efficiëntie.<br><br><a href="/marketplace/URL/" class="button">Meer informatie</a>'
