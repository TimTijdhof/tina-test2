...
hero:
  ...
  content: '<div class="usp-list"><ul><li>Slimme pop-up van elk gesprek</li><li>Direct
    de klantgegevens in beeld</li><li>Werk efficiënter</li></ul></div>Gegevens inladen via een CSV bestand is een generieke CRM koppeling. Meer specifiek gericht op excellente communicatie met jouw klanten. Email, chat, Whatsapp en natuurlijk hoort daar ook telefonie bij! En daar komt Callvoip om de hoek kijken: koppel jouw CSV nu aan onze telefonie en profiteer van het gemak en de efficiëntie.<br><br><a href="/marketplace/CSV/" class="button">Meer informatie</a>'
